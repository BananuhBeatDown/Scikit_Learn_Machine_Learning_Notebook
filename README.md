...
A Jupyter notebook exploring machine learning techniques using scikit-learn and pandas libraries. Based off of scikit-learn video's from [Kevin Hartman's No Free Hunch Kaggle Blog](http://blog.kaggle.com/author/kevin-markham/).
